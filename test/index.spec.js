...
test.serial('Inserts variables', async t => {
  ...
  t.is(sls.service.custom.repository, path.basename(t.context.tmpDir))
...
test.serial('Inserts variables (with remote origin)', async t => {
  fs.copySync('test/resources/full_remote_repo/git', `${t.context.tmpDir}/.git`)
  process.chdir(t.context.tmpDir)
  ...
  t.is(sls.service.custom.message, 'Another commit')
  t.is(sls.service.custom.describeLight, 'my_tag-1-g90440bd')
  t.is(sls.service.custom.repository, 'serverless-plugin-git-variables')
  t.is(sls.service.custom.gitUser, 'Full User')
  t.is(sls.service.custom.gitEmail, 'full@example.com')
  t.is(sls.service.custom.tags, '90440bd')
})
...
test.serial('One tag on HEAD (with remote origin)', async t => {
  fs.copySync('test/resources/full_remote_repo/git', `${t.context.tmpDir}/.git`)
  process.chdir(t.context.tmpDir)
...
test.serial('Multiple tags on HEAD (with remote origin)', async t => {
  fs.copySync('test/resources/full_remote_repo/git', `${t.context.tmpDir}/.git`)
  process.chdir(t.context.tmpDir)
...
test.serial('Env variables defined', async t => {
  ...
  t.is(func.environment.GIT_REPOSITORY, path.basename(t.context.tmpDir))
  ...
  t.is(func.tags.GIT_REPOSITORY, path.basename(t.context.tmpDir))
})

test.serial('Env variables defined (with remote origin)', async t => {
  fs.copySync('test/resources/full_remote_repo/git', `${t.context.tmpDir}/.git`)
  process.chdir(t.context.tmpDir)
  ...
  t.is(func.environment.GIT_IS_DIRTY, 'false')
  t.is(func.environment.GIT_TAGS, '90440bd')
  t.is(func.environment.GIT_REPOSITORY, 'serverless-plugin-git-variables')
  ...
  t.is(func.tags.GIT_IS_DIRTY, 'false')
  t.is(func.tags.GIT_TAGS, '90440bd')
  t.is(func.tags.GIT_REPOSITORY, 'serverless-plugin-git-variables')
})
...
test.serial('Whitelist', async t => {
  ...
  t.is(func.environment.GIT_REPOSITORY, undefined)
  ...
  t.is(func.tags.GIT_TAGS, '90440bd')
  t.is(func.tags.GIT_REPOSITORY, undefined)
})
